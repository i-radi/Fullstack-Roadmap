...
TO DISK = 'C:\Users\Radi\Desktop\BACKUPS\CRMDB.BAK' 
WITH NOINIT,
NAME = 'BACKUP_02',
DESCRIPTION = 'second backup'

RESTORE HEADERONLY FROM DISK = 'C:\Users\Radi\Desktop\BACKUPS\CRMDB.BAK';

BACKUP LOG CRMDB 
TO DISK = 'C:\Users\Radi\Desktop\BACKUPS\CRMDB_log.BAK'
WITH NOINIT,
NAME = 'BACKUP_LOG_01',
...
RESTORE HEADERONLY FROM DISK = 'C:\Users\Radi\Desktop\BACKUPS\CRMDB_log.BAK';
RESTORE FILELISTONLY FROM DISK = 'C:\Users\Radi\Desktop\BACKUPS\CRMDB_log.BAK';
...
FROM DISK = 'C:\Users\Radi\Desktop\BACKUPS\CRMDB.BAK'
WITH REPLACE,
MOVE 'CRMDB' TO 'C:\USERS\YOUYA\DESKTOP\DATA\CRMDB_TEST.mdf',
MOVE 'CRMDB_LOG' TO 'C:\USERS\YOUYA\DESKTOP\DATA\CRMDB_TEST_LOG.ldf',
NORECOVERY;

RESTORE LOG CRMDB_TEST FROM DISK = 'C:\Users\Radi\Desktop\BACKUPS\CRMDB_log.BAK'
WITH FILE = 1,
NORECOVERY
